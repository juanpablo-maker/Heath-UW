      ...
      <section className="bg-backgroundSecondary px-6 py-14 md:px-10 md:py-20">
        <div className="mx-auto grid max-w-5xl gap-4 md:grid-cols-3">
          {copy.pillars.map((pillar) => (
            <article key={pillar} className="rounded-2xl border border-border bg-background p-6 shadow-soft">
              <p className="text-sm leading-relaxed text-primary md:text-base">{pillar}</p>
            </article>
          ))}
        </div>
      </section>
      <section className="bg-background px-6 pb-16 md:px-10 md:pb-24">
        <div className="mx-auto flex max-w-5xl flex-wrap gap-3 rounded-2xl border border-border bg-backgroundSecondary p-6 md:items-center md:justify-between md:p-8">
          ...
          <div className="flex flex-wrap gap-3">
            ...
            <Link href="/portfolio" className="rounded-full border border-border bg-background px-6 py-2.5 text-sm font-semibold text-primary">
